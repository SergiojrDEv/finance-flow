...
| `domains/sync/cloud-sync-safety.spec.md` | Sincronizacao | `src/application/sync/planCloudCatalogSync.js`, `src/core/catalog.js`, `src/supabase/index.js` | `tests/application/sync/planCloudCatalogSync.test.js`, `tests/core/catalog.test.js` | Planner ligado ao runtime V2 para metas e orcamentos |
