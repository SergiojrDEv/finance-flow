export const typeScriptPrimarySourceFiles = [
  ...
  "src/application/navigation/appScreenModel.ts",
  ...
  "src/infrastructure/sync/CloudPullSyncService.ts",
  "src/infrastructure/sync/CloudPushSyncService.ts",
  "src/infrastructure/sync/CloudSnapshotHydrator.ts",
  "src/infrastructure/sync/LegacyCloudSnapshotHydrator.ts",
  "src/infrastructure/sync/LegacySyncPayload.ts",
  "src/infrastructure/sync/LegacyTransactionMapper.ts",
  "src/infrastructure/sync/SupabaseCatalogV2SyncRepository.ts",
  "src/infrastructure/sync/SupabaseCloudSnapshotRepository.ts",
  "src/infrastructure/sync/SupabaseLegacySyncRepository.ts",
  "src/infrastructure/sync/SupabaseSchemaRepository.ts",
