...
export const APP_SCREEN_COPY = Object.freeze({
...
export function getAppScreenModel(sectionId = "visao-geral") {
...
export function buildAppShellModel({ activeSection = "visao-geral" } = {}) {
